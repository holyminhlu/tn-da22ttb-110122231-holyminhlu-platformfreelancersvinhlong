    ...
    <section className="about-hero relative overflow-hidden py-20 text-white md:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mb-6 text-3xl font-bold leading-tight md:text-5xl">{ABOUT_INTRO.title}</h1>
          <p className="text-lg leading-relaxed text-neutral-300 md:text-xl">{ABOUT_INTRO.subtitle}</p>
        </div>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2">
          <div className="about-mission-card bg-white/10 p-8 backdrop-blur-sm">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold">{ABOUT_INTRO.mission.title}</h3>
            </div>
          ...
          <div className="about-vision-card bg-white/10 p-8 backdrop-blur-sm">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold">{ABOUT_INTRO.vision.title}</h3>
            </div>
            <p className="leading-relaxed text-neutral-300">{ABOUT_INTRO.vision.description}</p>
          </div>
        </div>
      </div>
    </section>
  ...
  return (
    <section className="bg-white py-20 md:py-24">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeading title="Tại sao chọn Vĩnh Long Connected?" />
        ...
        <div className="mb-16 grid items-center gap-12 lg:grid-cols-2">
          <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-xl">
            <Image
              ...
              alt="Cảnh quan Vĩnh Long — nơi khởi nguồn Vĩnh Long Connected"
              fill
              className="object-cover"
          ...
          {STORY.milestones.map((milestone, index) => (
            ...
            >
              ...
              <div className="flex-1 rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
                ...
                <h4 className="mt-1 mb-2 text-lg font-bold text-[#1c2e4a]">{milestone.title}</h4>
          ...
          {CORE_VALUES.map((value) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mb-3 text-lg font-bold text-[#1c2e4a]">{value.title}</h3>
...
function TeamSection() {
  return (
    <section className="border-t border-gray-100 bg-gray-50 py-20 md:py-24">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeading title="Đội ngũ của chúng tôi" />
        <p className="-mt-6 mb-12 text-center text-gray-600">
          Những con người đam mê đang vận hành và phát triển Vĩnh Long Connected mỗi ngày.
        </p>
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {TEAM_MEMBERS.map((member) => (
            ...
            >
              ...
              <h3 className="mb-1 text-lg font-bold text-[#1c2e4a]">{member.name}</h3>
  ...
  return (
    <section className="about-cta py-16 text-white md:py-20">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <h2 className="mb-4 text-2xl font-bold md:text-3xl">{ABOUT_CTA.title}</h2>
        <p className="mb-10 text-neutral-300">{ABOUT_CTA.subtitle}</p>
